...
func (_m *Provider) GetVerifierClient() (verifierapi.VerifierClient, error) {
	ret := _m.Called()

	var r0 verifierapi.VerifierClient
	if rf, ok := ret.Get(0).(func() verifierapi.VerifierClient); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(verifierapi.VerifierClient)
		}
	}
